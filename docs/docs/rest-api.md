...
New integrations should start with the native `/v1` routes below. The `/firecrawl/v2` routes are documented separately as the Firecrawl compatibility surface.
